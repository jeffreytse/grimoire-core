...
2. **Automatic IAP (regardless of culture result):**
...
3. **Culture-positive → IAP in labor:**
...
4. **Timing:** IAP must begin ≥4 hours before delivery to be fully protective — communicate GBS status clearly when going to labor and delivery.
5. **Culture unknown at delivery (no result/unscreened):**
   - Give IAP if: <37 weeks gestation, ROM ≥18 hours, or intrapartum fever ≥38°C
6. **Planned cesarean (no labor, intact membranes):** IAP not required even if GBS-positive — exposure risk is membrane/birth canal.
