...
1. **Screen with EPDS at every trimester and 6-week postpartum visit:**
...
2. **Also screen for anxiety** — EPDS anxiety subscale (items 3, 4, 5); GAD-7 is an alternative.
3. **If EPDS ≥13 or clinical concern:**
...
4. **Risk factors — increase monitoring frequency:**
...
5. **Safety planning:** if any suicidal ideation, complete a formal safety plan with provider before leaving visit.
6. **Partner/support person:** screen partner with EPDS — 10% of partners experience perinatal depression.
