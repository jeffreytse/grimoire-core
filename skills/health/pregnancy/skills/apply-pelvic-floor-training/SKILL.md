...
1. **Identify the correct muscles:** stop urine mid-stream once to locate the muscles — do not use this as regular practice, only for identification.
2. **Confirm isolation:** contract pelvic floor without squeezing buttocks, thighs, or abdomen. Place hand on abdomen — it should not tighten.
3. **Slow hold contractions (strength):**
   - Contract and hold for 10 seconds
   - Fully relax for 10 seconds
   - 10 reps × 3 sets/day
4. **Quick contractions (power/reflex):**
   - Contract and release rapidly 10–15 times
   - 1 set after each slow hold set
5. **Positions:** lying on side, sitting, standing — practice in all three to prepare for functional use.
6. **Progression:** increase hold time by 1 second per week up to 10 seconds; increase to 15 reps/set by third trimester.
7. **"The Knack" technique:** contract pelvic floor just before coughing, sneezing, or lifting — this reflex closes the urethra before pressure surges.
