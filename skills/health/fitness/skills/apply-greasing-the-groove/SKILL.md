---
name: apply-greasing-the-groove
description: Use when you want to rapidly increase strength or rep capacity in a specific movement (pull-ups, push-ups, kettlebell press, squats) — by practicing that movement multiple times per day at sub-maximal effort, never reaching fatigue.
source: 'Pavel Tsatsouline, "The Naked Warrior", Dragon Door Publications (2003); StrongFirst methodology; Schmidt & Bjork, "New Conceptualizations of Practice", Psychological Science (1992) — distributed practice evidence basis; Ericsson et al., "The Role of Deliberate Practice", Psychological Review (1993)'
tags: [strength, frequency-training, motor-learning, pull-ups, skill-acquisition, sub-maximal, greasing-the-groove]
---

# Apply Greasing the Groove
...
### 2. Establish your current maximum
...
### 3. Set up opportunities throughout the day
...
### 4. Execute each set with perfect form — stop well short of failure
...
### 5. Do NOT train the target movement in your regular workouts
...
### 6. Test and rebase every 2–4 weeks
...
- One movement at a time — GTG requires that you see the bar and think "pull-up" without hesitation; multiple movements split this neural groove
- Never train to failure during GTG — a single set to failure can depress the quality of all sets that day and the following day; failure is training a different quality than GTG targets
- Remove target movement from gym sessions — stacking gym pull-up sets on top of GTG sets creates fatigue accumulation that defeats the sub-maximal mechanism
- Daily application is required — missing 2+ days in a row loses the frequency benefit; if travel prevents bar access, substitute isometric holds or towel rows as a maintenance stimulus

## Common Mistakes

- **Doing GTG sets at 70–80% effort** — feels productive but defeats the mechanism; if 5 pull-ups out of a max of 6 feels like "sub-maximal effort", your max test was wrong; retest on a fresh day
- **Stopping GTG after 1–2 weeks due to "not feeling sore"** — no soreness is correct; GTG works through neural adaptation, not muscle damage; soreness is not the signal
- **Trying GTG on barbell squat or deadlift** — setup time makes 5–8 sets per day impractical; these movements also carry higher injury risk when fatigued; GTG is optimal for bodyweight or simple implements
- **Expecting GTG to replace all training** — GTG handles one movement; for overall programming, it slots in alongside a broader training plan; it is not a complete program