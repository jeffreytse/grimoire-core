...
Rules:
- Name the emotional experience, not the story about it — "I'm anxious" not "I'm anxious because my manager criticized me and that always happens"
- Use "there is" rather than "I am" where possible — this creates slight distance from the emotion without denial; "there is anger" vs "I am angry" activates a different neural response (labeling vs. identification)
- One accurate name is sufficient — naming 5 overlapping emotions simultaneously produces confusion; identify the dominant experience
...
1. The physical sensation in the body
2. The emotional tone
3. The core belief the emotion is activating
...
The nurture can be:
- A spoken phrase (internal or whispered)
- A physical gesture (hand on heart, hand on belly)
- An imagined supportive presence (someone who cares for you)
...
- Complete all four steps — stopping at Allow (tolerance) without Investigate and Nurture produces acceptance without insight; the full cycle is more effective than partial application
- Investigate the sensation, not the story — RAIN is not cognitive analysis of why you feel this way; it is present-moment investigation of what the feeling is like; "I feel tight in my chest" not "this is because my mother never validated me"
- Nurture must be sincere, not performative — "I am enough" said without any felt sense of care is not the Nurture step; if you can't feel warmth toward yourself, imagine offering this message to a friend, then turn it toward yourself
- Do not use RAIN to avoid needed action — RAIN metabolizes emotion; after completing it, if action is warranted (an apology, a boundary, a decision), take it

## Common Mistakes

- **Skipping Allow and jumping to Investigate** — analysis without acceptance keeps the defended part active; Allow must come before Investigate; investigating an emotion you are still resisting produces story, not observation
- **Using RAIN to bypass the emotion quickly** — rushing through to "feel better" defeats the purpose; Allow requires genuine 30–60 seconds of non-resistance; hurrying produces incomplete processing
