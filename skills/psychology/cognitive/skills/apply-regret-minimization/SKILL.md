---
name: apply-regret-minimization
description: Use when facing a major irreversible decision — career change, starting a company, relocating, committing to a relationship — to evaluate choices by projecting your future self's retrospective judgment rather than current-moment anxiety.
source: 'Jeff Bezos, Princeton Commencement Address (2010); Gilovich & Medvec, "The Experience of Regret: What, When, and Why", Psychological Review (1995); Zeelenberg et al., "The Experience of Regret and Disappointment", Cognition & Emotion (2002); Kahneman & Miller, "Norm Theory", Psychological Review (1986)'
tags: [decision-making, regret, long-term-thinking, career, cognitive, clarity]
---
...
### 6. Decide — but separate the decision from the planning
...
- Use only for irreversible or high-commitment decisions — the framework's power comes from forcing long-term perspective on high-stakes choices; applying it to low-stakes decisions creates decision fatigue without benefit
- Commit to the age-80 projection genuinely — a superficial "I guess I'd regret it" doesn't activate the temporal shift; spend 60 seconds actually imagining the future self before evaluating
- Do not use regret minimization to rationalize impulsive action — if you haven't identified the specific costs of the action (financial, relational, health), do fear-setting first; regret minimization answers direction, not feasibility

## Common Mistakes

- **Using regret minimization for operational decisions** — "Should I send this email today or tomorrow?" doesn't benefit from an age-80 projection; reserve the framework for genuinely irreversible choices
- **Conflating current anxiety with future regret** — "I'll regret this if it goes wrong" describes current fear, not age-80 regret; the framework requires genuinely projecting forward, not relabeling present emotion
- **Stopping at direction without moving to execution** — deciding to start a company is not starting a company; regret minimization generates intent; pair with fear-setting and project planning to convert intent into action
- **Treating "I won't regret not trying" as conclusive** — if age-80 you wouldn't regret the inaction, examine why: is it genuinely low-priority, or is it a rationalization? The Gilovich research shows this is rare for meaningful personal endeavors