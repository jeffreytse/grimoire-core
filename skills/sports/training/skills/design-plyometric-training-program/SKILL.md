...
1. **Low intensity:** standing jumps (box jumps, broad jump, countermovement jump), skipping variations
2. **Moderate intensity:** multiple jumps, lateral bounds, step-bounds, medicine ball throws
3. **High intensity:** depth drops, depth jumps, single-leg bounding, hurdle hops
4. **Very high intensity:** shock-method depth jumps (box heights 60-110cm), continuous single-leg bounds
