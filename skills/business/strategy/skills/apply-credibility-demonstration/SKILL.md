...
# Apply Credibility Demonstration
...
1. **Diagnose whether resistance is opposition or disbelief.** Before designing the credibility demonstration, identify which problem you're solving. Ask directly: "Do you disagree with this direction, or do you doubt we'll actually follow through?" Opposition requires understanding and addressing concerns. Disbelief requires demonstration. If the honest answer is "both," address opposition through dialogue first, then use credibility demonstration to address residual disbelief.

2. **Identify a small, verifiable, costly commitment you can make immediately.** The demonstration must meet three criteria:
   - **Visible:** Observable by the skeptical audience — not done privately or reported only through internal channels
   - **Costly:** Something that requires genuine effort or sacrifice, not symbolic zero-cost gestures
   - **Verifiable:** The audience can independently confirm whether you followed through

3. **Make the commitment publicly and specifically.** State exactly what you will do, when, and what the outcome will be. Vague commitments ("we'll work on this") cannot demonstrate follow-through because the standard for success is undefined. Shang Yang stated a specific reward for a specific action — unambiguous and verifiable.

4. **Follow through completely and publicly, without qualification.** When the time comes to honor the demonstration commitment, do so fully and visibly. Do not partially honor it, redefine the terms, or honor it quietly. The credibility value comes from the audience witnessing complete follow-through without exception. Shang Yang paid fifty gold pieces to someone he had never met, for moving a piece of wood — demonstrating that the reward was real even when it seemed absurd.

5. **Make the connection explicit before the main announcement.** After the demonstration, name what it means: "We said we would do X. We did X. Now we are announcing Y." Explicitly linking the demonstrated commitment to the credibility of the forthcoming major announcement prevents audiences from treating them as unrelated events.

6. **Time the major announcement immediately after the demonstration.** Credibility demonstrated decays. Shang Yang announced the reforms immediately after paying the reward. A 6-month gap between demonstration and major announcement loses the credibility transfer.

7. **Design Kotter-style short-term wins into multi-year change programs.** For long-duration change programs, the credibility demonstration problem recurs at each phase. Design visible, verifiable wins at 90-day intervals — not because the wins are strategically important, but because they continuously re-establish that the program will follow through.

## Rules

- The demonstration commitment must be one you are certain you can honor. A failed demonstration is worse than no demonstration — it confirms that commitments will not be honored. Only commit to what you are certain you will deliver.
- Do not let the demonstration be seen as a stunt. The perceived authenticity of the demonstration determines its credibility value. Shang Yang's post worked because the reward was real money paid to a real person. PR-designed "gestures" that are perceived as theatrical produce no credibility transfer.
- Do not confuse announcement with demonstration. Announcing that you will follow through is not a demonstration that you will. The demonstration must precede the announcement of intent — not follow it.
- Apply this technique when credibility is genuinely in doubt, not as a default prefix to every announcement. When credibility is already established (prior track record of follow-through is visible to the audience), the demonstration step is unnecessary.
...
- **Using a symbolic gesture instead of a costly demonstration:** Announcing "we're committed to this" with visible but zero-cost actions (renaming a meeting, adding a slide deck, hiring a consultant) produces no credibility transfer because there is no demonstrated sacrifice. Cost is what makes the demonstration credible.
- **Honoring the demonstration quietly:** If the follow-through isn't visible to the skeptical audience, the credibility event doesn't register. Complete and public fulfillment is required.
- **Starting with the major announcement:** The instinct is to announce the full vision first, then demonstrate commitment through execution. In high-skepticism environments, this fails because the audience doesn't believe the execution will happen. The demonstration must precede the major announcement.
- **Designing the demonstration for insiders:** If the credibility problem is with a frontline or external audience, the demonstration must be visible to that audience — not to executives or internal stakeholders. Credibility demonstrations visible only to the already-converted solve nothing.