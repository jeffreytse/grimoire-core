...
**Open with calibration anchors (15 min):**
Align on what each rating level means using behavioral anchors, not just label definitions:
```
...
**Manager-by-manager review (60–90 min):**
For each manager, briefly review their team's distribution:
...
**Promotion discussion (30 min, if applicable):**
Surface employees nominated for promotion. For each:
1. Presenting manager makes the case with specific evidence
2. Group calibrates: "Is this readiness we're seeing from this person, or is this manager advocacy?"
3. Group reaches a recommendation: promote, develop for 1 cycle, or not ready
