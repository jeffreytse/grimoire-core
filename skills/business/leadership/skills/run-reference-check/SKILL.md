...
### 1. Call references — do not email
...
### 2. Get references from former managers — not the candidate's list alone
...
### 3. Open the reference call with context-setting
...
### 4. Ask the five core reference questions

After context-setting, ask these five questions in order:

**1. "In what context did you work with [Name], and for how long?"**
Context matters: managing a team of 2 is different from managing 50; working in a startup is different from an enterprise. Establish what you're comparing against.

**2. "What were [Name]'s biggest strengths in that role?"**
This is easy for the reference to answer and gets the conversation going. Listen for specificity — vague positives ("great communicator") signal less genuine enthusiasm than specific ones ("she had a gift for translating technical complexity into business terms that our CFO could act on").

**3. "What were the areas where [Name] could have done better or needed the most development?"**
This is the most important question. Most references will give at least one genuine development area if asked directly. Probe: "Can you give me a specific example of a time when that came up?"
...
**4. "How would you rate their overall performance on a 1–10 scale, with 10 being exceptional?"**
Numbers cut through diplomatic language. An 8 is good. A 9 or 10 is exceptional. A 7 is a warning sign dressed as a positive. A reference who says "9" and then gives two strong development areas is giving consistent data. A reference who says "8" with four strengths and no development areas is telling you something incoherent — probe.

Follow up on any score below 9: "What would have made them a [one point higher]?"

**5. "Would you hire [Name] again if you had the right role?"**
This is the most predictive single question. A genuine enthusiastic "absolutely yes" is a strong positive signal. Hesitation, hedging ("it would depend on the role"), or a qualified "yes" are all worth probing.
...
### 5. Use "the aha moment" question for critical roles
...
### 6. Pattern-match across 4–7 references
...
- Do the strength themes repeat across 3+ references? (High signal)
- Do the development areas repeat? (Especially high signal — the same growth area named by 3 different former managers, independently, is almost certainly real)
- Is there significant disagreement between references? (Understand why — different context, different time period, or genuine inconsistency)
- What did the candidate say about their relationship with each reference? Does that match the reference's account?
...
- Call, don't email — tone, enthusiasm, and hesitation are signal; email produces liability-managed non-information
- Get references from former managers, not only the candidate's list — people not on the list are often the most informative; always contact the last 3 direct managers
- Ask "would you rehire them?" — this is the most predictive single question; probe any answer that isn't an enthusiastic yes
- Pattern across 4–7 references — one reference is an anecdote; four references with the same development theme is a finding
- Compare reference accounts against the candidate's self-description — systematic inconsistency between what the candidate said and what 3 references say is the most important signal

## Common Mistakes

- **Email reference checks**: legally safe for the reference, nearly useless for you; insist on phone calls.
- **Only calling the candidate's provided references**: these are pre-selected advocates; contact the last 3 managers directly, whether or not they're on the list.
- **Accepting "nothing comes to mind" as an answer to development questions**: everyone has development areas; a reference who claims otherwise either doesn't know the person well or is protecting them; follow up directly.
- **Not asking the rehire question**: this is the single most predictive question and is commonly skipped out of politeness; it must be asked.
- **One reference check instead of 4–7**: a single reference is too noisy to act on; patterns across multiple references are reliable.

## When NOT to Use

- When reference information would violate local employment law (some jurisdictions restrict reference disclosures) — work with HR and legal to understand what can be asked and shared in your jurisdiction before conducting checks.
- For contract or short-term roles where the hire timeline is hours, not days — compress to 1–2 calls on the most critical competencies; some reference data is better than none.