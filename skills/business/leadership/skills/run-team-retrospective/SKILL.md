...
- As a venue for individual feedback — retrospective data is team-level; using a retro to surface feedback about a specific person's performance changes the psychological safety of the session; individual feedback belongs in one-on-ones and performance processes.