...
**Adopted by:** Google's Project Oxygen (2008–2018) identified coaching as the #1 behavior of effective managers across all Google manager effectiveness surveys; the GROW model originated with John Whitmore and Timothy Gallwey, was formalized in the 1980s at McKinsey, and is now the standard coaching framework taught in corporate leadership programs at Google, Microsoft, Unilever, and the International Coaching Federation (ICF); Michael Bungay Stanier's "The Coaching Habit" — built on the same principles — has sold 1M+ copies and is used in manager training at LinkedIn, Slack, and Shopify
**Impact:** Google's Project Oxygen data showed that managers with high coaching scores had direct reports with significantly higher performance ratings, lower attrition, and higher satisfaction scores; the key causal mechanism: coaching-style managers build employee self-sufficiency, while advice-giving managers build dependency — dependency requires continuous manager involvement and collapses when the manager is unavailable; Whitmore's research documents that people are 3–4× more likely to follow through on solutions they generated themselves versus solutions given to them
**Why best:** Advice-giving (the default manager behavior) creates the right answer in the short term but the wrong habit in the long term — the employee learns to wait for the manager's answer rather than developing their own judgment; GROW provides a repeatable four-stage structure that guides employees to their own solutions while the manager facilitates, making the manager a multiplier rather than a bottleneck
...
- The employee has a problem they're stuck on but likely has the resources to solve it
- The employee is developing a skill and needs to build their own judgment, not execute your approach
- The employee is making a decision where their ownership matters to the outcome

A coaching conversation is NOT appropriate when:
- There is one correct answer the employee doesn't have (teach or direct instead)
- Speed is critical (coaching takes longer than telling in the short term)
- Safety or compliance is involved (non-negotiable standards require clear direction)
...
### 2. G — Goal: establish what they want from this conversation
...
### 3. R — Reality: understand the current situation without solving it
...
### 4. O — Options: generate possibilities before evaluating them
...
### 5. W — Will: commit to specific action
...
- Ask before telling — the default switch is from advice to questions; if you find yourself explaining and advising more than asking, you've left coaching mode
- Generate before evaluating — in the Options phase, generate at least 3–5 options before asking which to pursue; premature evaluation locks in the obvious answer
- Their solution, not yours — if your preferred answer emerges, offer it as a question: "Have you considered [option]?" not "You should do [option]"
- One question at a time — stacked questions ("What did you try and what was the result and what would you do differently?") produce fragmented answers; one question, then wait
- Silence is productive — resist filling pauses; thinking looks like silence; discomfort with silence makes managers revert to advising

## Common Mistakes

- **Coaching when the right answer is teaching**: if the employee genuinely doesn't have the knowledge needed, GROW is the wrong tool — teach the concept first, then coach on application.
- **Asking leading questions**: "Wouldn't it make sense to do X?" is not coaching; it is advice framed as a question and is immediately recognized as such, which damages trust.
- **Skipping the Goal stage**: jumping straight into Reality without establishing what outcome the employee wants produces an unfocused conversation; the Goal anchors everything that follows.
- **Stopping at Options without Will**: the most common GROW failure mode is a great conversation that ends with "interesting discussion" and no concrete commitment; if there is no specific action and timeline, the coaching didn't produce change.
- **Switching to advice mid-conversation**: when a coaching conversation surfaces a problem the manager wants to solve, the pull to give advice is strong; name it: "I have a strong instinct to give you my answer — but I want to hear yours first."

## When NOT to Use

- When the employee needs a decision made, not helped: some situations require the manager to make a call; coaching when someone needs a decision frustrates them and wastes time.
- When there is a clear compliance or safety issue with one correct answer: coaching implies that the employee's answer is as valid as any other; for non-negotiable standards, teach and direct.
- When the employee is in acute distress: a coaching conversation requires cognitive bandwidth to explore and generate; a person in crisis needs acknowledgment and support first; coaching comes after stabilization.
- For experienced employees on tasks they have mastered: D4 employees on familiar work don't benefit from GROW questioning; they need clear outcomes and autonomy (S4 delegation); coaching is for developing judgment, not for people who already have it.